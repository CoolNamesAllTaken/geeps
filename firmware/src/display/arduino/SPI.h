...
class SPIClassRP2040 : public arduino::HardwareSPI {
   public:
    ...
    inline bool setMISO(pin_size_t pin) { return setRX(pin); }
    bool setCS(pin_size_t pin);
    bool setSCK(pin_size_t pin);
    bool setTX(pin_size_t pin);
    inline bool setMOSI(pin_size_t pin) { return setTX(pin); }
    ...
    // virtual void usingInterrupt(int interruptNumber) /*override*/ { _helper.usingInterrupt(interruptNumber); }

    // virtual void notUsingInterrupt(int interruptNumber) /*override*/ { _helper.notUsingInterrupt(interruptNumber); }

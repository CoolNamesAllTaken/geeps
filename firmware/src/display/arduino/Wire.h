...
class TwoWire : public Stream {
   public:
    ...
    bool writeReadAsync(uint8_t address, const void *wbuffer, size_t wbytes, const void *rbuffer, size_t rbytes,
                        bool sendStop = true);
    ...
    void setTimeout(uint32_t timeout = 25,
                    bool reset_with_timeout = false);  // sets the maximum number of milliseconds to wait

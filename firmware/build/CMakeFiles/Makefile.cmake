...
set(CMAKE_MAKEFILE_DEPENDS
  ...
  "../inc/CMakeLists.txt"
  "../inc/display/CMakeLists.txt"
  "../inc/gps/CMakeLists.txt"
  "../pico_sdk_import.cmake"
  "../src/CMakeLists.txt"
  "../src/display/CMakeLists.txt"
  "../src/gps/CMakeLists.txt"
  "/usr/local/pico-sdk/CMakeLists.txt"
  "/usr/local/pico-sdk/cmake/Platform/PICO.cmake"
  "/usr/local/pico-sdk/cmake/pico_pre_load_platform.cmake"
  "/usr/local/pico-sdk/cmake/pico_pre_load_toolchain.cmake"
  "/usr/local/pico-sdk/cmake/pico_utils.cmake"
  "/usr/local/pico-sdk/cmake/preload/platforms/pico/pico.cmake"
  "/usr/local/pico-sdk/cmake/preload/platforms/rp2040.cmake"
  "/usr/local/pico-sdk/cmake/preload/toolchains/find_compiler.cmake"
  "/usr/local/pico-sdk/cmake/preload/toolchains/pico_arm_gcc.cmake"
  "/usr/local/pico-sdk/docs/CMakeLists.txt"
  "/usr/local/pico-sdk/lib/tinyusb/hw/bsp/family_support.cmake"
  "/usr/local/pico-sdk/lib/tinyusb/hw/bsp/rp2040/boards/pico_sdk/board.cmake"
  "/usr/local/pico-sdk/lib/tinyusb/hw/bsp/rp2040/family.cmake"
  "/usr/local/pico-sdk/lib/tinyusb/hw/bsp/rp2040/pico_sdk_import.cmake"
  "/usr/local/pico-sdk/pico_sdk_init.cmake"
  "/usr/local/pico-sdk/pico_sdk_version.cmake"
  "/usr/local/pico-sdk/src/CMakeLists.txt"
  "/usr/local/pico-sdk/src/board_setup.cmake"
  "/usr/local/pico-sdk/src/boards/generic_board.cmake"
  "/usr/local/pico-sdk/src/common/CMakeLists.txt"
  "/usr/local/pico-sdk/src/common/boot_picoboot/CMakeLists.txt"
  "/usr/local/pico-sdk/src/common/boot_uf2/CMakeLists.txt"
  "/usr/local/pico-sdk/src/common/pico_base/CMakeLists.txt"
  "/usr/local/pico-sdk/src/common/pico_base/generate_config_header.cmake"
  "/usr/local/pico-sdk/src/common/pico_base/include/pico/version.h.in"
  "/usr/local/pico-sdk/src/common/pico_binary_info/CMakeLists.txt"
  "/usr/local/pico-sdk/src/common/pico_bit_ops/CMakeLists.txt"
  "/usr/local/pico-sdk/src/common/pico_divider/CMakeLists.txt"
  "/usr/local/pico-sdk/src/common/pico_stdlib/CMakeLists.txt"
  "/usr/local/pico-sdk/src/common/pico_sync/CMakeLists.txt"
  "/usr/local/pico-sdk/src/common/pico_time/CMakeLists.txt"
  "/usr/local/pico-sdk/src/common/pico_usb_reset_interface/CMakeLists.txt"
  "/usr/local/pico-sdk/src/common/pico_util/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2040.cmake"
  "/usr/local/pico-sdk/src/rp2040/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2040/hardware_regs/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2040/hardware_structs/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common.cmake"
  "/usr/local/pico-sdk/src/rp2_common/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/boot_stage2/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/cmsis/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/hardware_adc/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/hardware_base/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/hardware_claim/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/hardware_clocks/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/hardware_divider/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/hardware_dma/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/hardware_exception/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/hardware_flash/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/hardware_gpio/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/hardware_i2c/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/hardware_interp/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/hardware_irq/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/hardware_pio/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/hardware_pll/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/hardware_pwm/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/hardware_resets/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/hardware_rtc/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/hardware_spi/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/hardware_sync/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/hardware_timer/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/hardware_uart/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/hardware_vreg/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/hardware_watchdog/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/hardware_xosc/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/pico_bit_ops/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/pico_bootrom/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/pico_bootsel_via_double_reset/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/pico_cxx_options/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/pico_divider/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/pico_double/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/pico_fix/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/pico_fix/rp2040_usb_device_enumeration/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/pico_float/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/pico_int64_ops/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/pico_malloc/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/pico_mem_ops/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/pico_multicore/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/pico_platform/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/pico_printf/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/pico_runtime/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/pico_standard_link/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/pico_stdio/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/pico_stdio_semihosting/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/pico_stdio_uart/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/pico_stdio_usb/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/pico_stdlib/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/pico_unique_id/CMakeLists.txt"
  "/usr/local/pico-sdk/src/rp2_common/tinyusb/CMakeLists.txt"
  "/usr/local/pico-sdk/tools/CMakeLists.txt"
  "/usr/local/pico-sdk/tools/FindELF2UF2.cmake"
...
set(CMAKE_MAKEFILE_PRODUCTS
  ...
  "inc/display/CMakeFiles/CMakeDirectoryInformation.cmake"
  "inc/gps/CMakeFiles/CMakeDirectoryInformation.cmake"
  )

# Dependency information for all targets:
set(CMAKE_DEPEND_INFO_FILES
  "CMakeFiles/ELF2UF2Build.dir/DependInfo.cmake"
  "CMakeFiles/geeps.dir/DependInfo.cmake"

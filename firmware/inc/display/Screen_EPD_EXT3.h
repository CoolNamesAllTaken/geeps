...
#include "hardware/gpio.h" // for CS pins
#include "hardware/spi.h" // for SPI stuff
...
class Screen_EPD_EXT3 final : public hV_Screen_Buffer
{
  public:
    ...
    ///
    Screen_EPD_EXT3(eScreen_EPD_EXT3_t eScreen_EPD_EXT3, pins_t board, spi_inst_t * epd_spi);
